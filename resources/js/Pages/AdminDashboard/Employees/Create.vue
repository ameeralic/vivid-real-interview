<template>
    <!-- Modal content -->
    <Modal :modalHeadingText="'Create new Employee'" :modalHeadingResetButton="true" :modalWidth="2">
        <template #body>
        ...
        <template #footer>
            <Button
                @click.prevent="createRequest({ url: '/admin-dashboard/employees', data: userInfo, only: ['flash', 'errors'] })"
                :text="'Create Employee'" :color="'blue'"></Button>
        </template>
    </Modal>
</template>
<script>
